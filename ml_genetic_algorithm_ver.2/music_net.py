...
if __name__ == '__main__':
	...
	for i in range(500):
		...
		if (pred_y == label[0]):
			num_correct_test += 1
	print("Train Accuracy: {:2f}".format(num_correct_train/(1.5*num_of_training)))
	print("Test Accuracy: {:2f}".format(num_correct_test/(0.5*num_of_training)))

	# saving net data
	torch.save(net.state_dict(), 'music_net_1.tar')
